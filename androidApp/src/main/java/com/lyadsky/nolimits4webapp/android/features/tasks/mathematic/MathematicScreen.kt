package com.lyadsky.nolimits4webapp.android.features.tasks.mathematic
...
import com.lyadsky.nolimits4webapp.android.features.tasks.mathematic.layouts.OnePrimerScreen
import com.lyadsky.nolimits4webapp.android.features.tasks.mathematic.layouts.ThreePrimerScreen
import com.lyadsky.nolimits4webapp.android.features.tasks.mathematic.layouts.TwoPrimerScreen
...
fun MathematicScreen(
    ...
    Column(
        ...
        when (state.value.stage) {
            1 -> OnePrimerScreen(viewModelWrapper)
            2 -> TwoPrimerScreen(viewModelWrapper)
            3 -> ThreePrimerScreen(viewModelWrapper)
            else -> {}
        }
    }
}
